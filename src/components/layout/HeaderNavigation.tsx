...
const HeaderNavigation: VFC<Props> = ({ active }) => {
  ...
  if (!active) return <></>;
  return (
    <nav className="absolute z-10 top-[72px] left-0 w-screen h-screen bg-gradient-to-b from-primary-dark-blue to-transparent lg:w-screen lg:min-w-auto lg:h-[64px] lg:top-0 lg:bg-none">
