...
const HeaderNavigation: VFC<Props> = ({ active }) => {
  ...
  if (!active) return <></>;
  return (
    <nav className="absolute z-10 top-[72px] left-0 w-screen h-screen bg-gradient-to-b from-primary-dark-blue to-transparent xl:w-screen xl:min-w-auto xl:h-[64px] xl:top-0 xl:bg-none">
